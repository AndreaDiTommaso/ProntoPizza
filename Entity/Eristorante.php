...
class Eristorante
{
	...
	public function set_ristoratore(Eristoratore $r){$this->ristoratore=$r;}   
    ...
    public function get_ristoratore(){return (object) $this->ristoratore;}
 ...
 /*public function carica()
   {
      ...
      $y=new Eutente;
      $y->set_nome_utente($x[0]['ristoratore']);
      //$y->carica();
      $this->ristoratore=$y;
      $y=new Ecibo();
      $y=new Fcibo($y);
